#!/usr/bin/env python
"""
Рабочий Telegram бот для тестирования
⚠️ УСТАРЕВШИЙ ФАЙЛ - используйте integrated_bot.py или Django management command
"""
import os
import sys
import nest_asyncio
...
# Применяем nest_asyncio для исправления проблем с event loop
nest_asyncio.apply()
...
async def help_command(update: Update, context):
    ...
    help_text = (
        ...
        "/addcode - Добавить тестовый код (для разработки)\n\n"
        "*🔧 Как я работаю:*\n"
